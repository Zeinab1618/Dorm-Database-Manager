...
if selected_table == "student":
                ...
                if not student_name or not contact:
                    ...
                    try:
                        ...
                        if cursor.fetchone():
                            ...
                            # Check if room_id exists and has capacity
                            ...
                            if not room:
                                ...
                                if cursor.fetchone():
                                    st.error("Contact number already exists. Please use a unique contact.")
                                else:
                                    try:
                                        # Insert student
                        ...
                        st.error(f"Error checking student or room: {e}")
    ...
    if st.button("Delete Student"):
        try:
            ...
            st.error(f"Error checking student: {e}")
